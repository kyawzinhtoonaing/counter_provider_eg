...
import 'fb_page2.dart';

class FbPage1 extends StatelessWidget {
  static const String routeName = "/fb/page1";
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Feature B - Page 1"),
      ),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton(
                onPressed: () {
                  Navigator.pushNamed(context, FbPage2.routeName);
                },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: (){
          fbp.emitEvent(FbP1IncreaseCounterEvent(1));
        },
        tooltip: 'Increment',
